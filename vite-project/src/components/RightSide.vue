...
<template>
  <div class="rightSide w-2/3 min-h-[100vh] relative">
    <div
      class="header pl-4 pr-6 fixed flex items-center justify-between h-[56px] bg-white w-[calc(100%-364px)] border-b border-[#0000001a]"
    >
      ...
      <picture>
        <source media="(m/in-width: )" srcset="" />
        <img src="" alt="" />
      </picture>
